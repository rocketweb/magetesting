...
class RocketWeg_Cli_Kit_UserTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testInit()
    {
        ...
        $this->assertEquals(
            "sudo sh '".$this->_scriptPath()."/create_user.sh' 'login' 'pass' 'salt_hash' '/home/login_dir' 2>&1",
    ...
    {
        $this->assertEquals(
                "sudo sh '".$this->_scriptPath()."/remove_user.sh' 'login' 2>&1",
    ...
    {
        $this->assertEquals(
                "sudo sh '".$this->_scriptPath()."/phpmyadmin-user-rebuild.sh' \"whole denied list of users\" 2>&1",
